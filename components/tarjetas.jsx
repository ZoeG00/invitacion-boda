...
export default function Tarjetas() {
  ...
  return (
    <div className="relative flex flex-col items-center bg-timberwolf p-8 w-full h-full">
      ...
      <p
        id="medios-de-pago"
        className="text-timberwolf bg-pumpkin px-16 mb-5 text-2xl font-semibold"
      >
        Medios de pago
      </p>
      <p className="text-center mb-8 text-gray-600">
        Queridos amigos y familia, hemos creado un espacio especial para
        ustedes. Les pedimos amablemente abonar a tiempo el costo
        correspondiente. ¡Gracias por ser parte de esta celebración y hacerla
        aún más memorable!
      </p>
            ...
            <div className="divide-y divide-gray-300">
              <div className="py-4">
                <p className="text-gray-700">
                  <strong>Costo de la tarjeta:</strong> $25.000
                </p>
              </div>
              <div className="py-4">
                <p className="text-gray-700">
                  <strong>Niños (4-10 años):</strong> $10.000
                </p>
              </div>
              <div className="py-4">
                <p className="text-gray-700">
                  <strong>Tarjeta de baile:</strong> $10.000
                </p>
              </div>
            </div>
            <button
            ...
            <div className="divide-y divide-gray-300">
              ...
              <div className="py-4">
                ...
                <div className="flex justify-center items-center mt-2">
                  <span>
                    Alias: <strong>zoeguzman.2000</strong>
                  </span>
                  <FaCopy
                ...
                <div className="flex justify-center items-center mt-2">
                  <span>
                    CVU: <strong>0000003100018947006113</strong>
                  </span>
                  <FaCopy
                    className="text-pumpkin cursor-pointer hover:scale-110 transition duration-300"
